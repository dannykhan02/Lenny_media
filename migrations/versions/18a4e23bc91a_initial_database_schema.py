...
Revision ID: 18a4e23bc91a
Revises: 
Create Date: 2026-01-05 12:07:41.029564
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('ADMIN', 'PHOTOGRAPHER', 'VIDEOGRAPHY', 'STAFF', name='userrole'), nullable=False),
    sa.Column('phone', sa.String(length=20), nullable=True),
    ...
    sa.Column('status', sa.Enum('PENDING', 'SENT', 'ACCEPTED', 'REJECTED', 'CANCELLED', name='quotestatus'), nullable=False),
